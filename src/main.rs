...
fn print_day(day: usize) {
    ...
    let result: Option<(Box<dyn Display>, Box<dyn Display>)> = match day {
        ...
        8 => printbox(days::day08::solve, "data/day08.txt"),
        9 => None,
        10 => printbox(days::day10::solve, "data/day10.txt"),
        11 => printbox(days::day11::solve, "data/day11.txt"),
        12 => None,
        13 => printbox(days::day13::solve, "data/day13.txt"),
        //14 => printbox(days::day14::solve, "data/day14.txt"),
        14..=25 => None,
        _ => unreachable!(),
    };
